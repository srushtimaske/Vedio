...
export default function JoinMeeting() {
  ...
  const myMeeting = async (element: any) => {
    ...
    zp?.joinRoom({
      ...
      showTurnOffRemoteCameraButton: true, // Set to true or false based on your requirements
      showTurnOffRemoteMicrophoneButton: true, // Set to true or false based on your requirements
      showRemoveUserButton: true, // Set to true or false based on your requirements
    });
